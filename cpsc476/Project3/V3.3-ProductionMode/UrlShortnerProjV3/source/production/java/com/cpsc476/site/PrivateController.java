...
import com.cpsc476.site.url.UrlDaoInterface;
...
public class PrivateController {
	...
	private String createURL(HttpServletRequest request, String lurl) throws ServletException, IOException {
		...
		String shorturlstr = Base64.getUrlEncoder().encodeToString(lurl.getBytes("utf-8")).substring(0, 6);
		String shorturl = "http://mini-shortner.herokuapp.com/" +"S"+ shorturlstr;
		return shorturl;
